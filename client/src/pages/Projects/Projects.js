      ...
      <div className="continer project" id="projects">
        ...
        <Fade left>
            ...
            <div className="col-md-4">
              <div className="card rounded">
                <div className="card-image">
                  <span className="card-notify-badge">fontend</span>
                  <img
                    src="/prj1.png"
                    alt="project1"
                  />
                ...
                <div className="card-body text-center">
                  <div className="ad-title m-auto">
                    <h5 className="text-uppercase">Pops Web</h5>
                  </div>
                  <a className="ad-btn" href="https://cantran04.github.io/Pops_css/index.html">
                    View
                  </a>
                </div>
              </div>
            ...
            <div className="col-md-4">
              <div className="card rounded">
                ...
                <div className="card-body text-center">
                  <div className="ad-title m-auto">
                    <h5 className="text-uppercase">Ryouri Web</h5>
                  </div>
                  <a className="ad-btn" href="https://ryouri.onrender.com/">
                    View
                  </a>
                </div>
              </div>
